...
class Register extends React.Component {
    ...
    async componentDidMount() {
        const response = await axios.get("https://localhost:3002/users");
                ...
                <div className="container justify-center" style={{ width: "40%" }}>
                    <form id="sampleForm" className="m-4">
                        <div className="form-group p-3">
                            ...
                            <input type="text" className="form-control formlar" onBlur={this.emailValidation} style={{ borderTop: "0px", borderLeft: "0px", borderRight: "0px" }} id="txtEmail" aria-describedby="emailHelp" placeholder="&#xf007;" />
                        </div>
                        <div className="form-group p-3">
